function Toast({ className, type = 'signinSuccess', content, icon }) {
  return (
    <div className={className}>
      <div className="flex flex-col justify-center">
        <div
          className="bg-green-500  mx-auto w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3"
          id="static-example"
          role="alert"
          aria-live="assertive"
          aria-atomic="true"
        ...
        >
          ...
          <div className="p-3 bg-green-500 rounded-b-lg break-words text-white">{content}</div>
        </div>
      </div>
    </div>
  );
