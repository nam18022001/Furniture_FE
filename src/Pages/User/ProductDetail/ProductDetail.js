...
function ProductDetail() {
  ...
  return (
    productInfo && (
      <>
        <ToastContainer />
        <div className="mt-12 container grid grid-cols-2 gap-6">
          <div>
            <Image
          ...
          <div>
            ...
            <div className="flex items-center mb-4">
              <div className="text-xl text-gray-500 ml-3">{comments.length} comments</div>
            </div>
            ...
            <div className="flex items-baseline mb-1 space-x-2 font-roboto mt-4">
              <p className="text-2xl text-primary font-semibold">{productInfo.salePrice.toLocaleString()} VND</p>
              <p className="text-2xl text-gray-400 line-through">{productInfo.price.toLocaleString()} VND</p>
            </div>

            <p className="mt-4 text-gray-600">{productInfo.description}</p>
            ...
            <div className="mt-6 flex gap-3 pb-5 pt-5">
              <button
                className=" text-white px-8 py-2 font-medium rounded uppercase flex items-center gap-2  hover:bg-slate-600 bg-slate-500 hover:text-black transition"
        ...
        <div className="container pb-16">
          ...
          <div className="w-3/5 pt-6 flex flex-col-reverse">
